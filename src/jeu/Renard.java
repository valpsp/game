...
public class Renard extends Faction implements Unite
{
	...
	/**
	 * IMPORTANT
	 * Methode qui permet d'obtenir une instanciation de renard si il n'est pas déjà instancié
	 */
	...
	public void render(Graphics g)
	{
		...
		if(pv > 0)
		{
			...
			//Le renard se déplace ? On affiche les animations de mouvemnent
			else
			{
				if(attaqueSubie > 10)
					g.drawAnimation(animations[direction+8], x-19, y-33);
	...
	/**
	 * Update l'état de le renard
	 * On appelle sa fonction d'IA qui gère son comportement
	 */
	public void update(int delta)
	{
		//Pour les tests, où regarde le renard
		this.regardX = this.x;
		this.regardY = this.y;
	...
	/**
	 * Déplacement manuel de le renard
	 * @param key
	 */
