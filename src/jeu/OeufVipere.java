 ...
 *
 */
public class OeufVipere extends Reptile
{
	private float x, y;
	 ...
	 * @param map
	 */
	public OeufVipere(Map map, float x, float y)
	{
		this.x = x;
		this.y = y;
	...
	public void init()
	{
		...
		try
		{
			spriteSheet = new SpriteSheet("src/main/ressources/sprites/monsters/egg2.png", 12, 12);
